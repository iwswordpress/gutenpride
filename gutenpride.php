...
function winwar_enqueue_fonts() {
 
	wp_enqueue_style( 'Roboto', '<link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400&display=swap" rel="stylesheet">', array(), '1.0' );
	
   } add_action( 'wp_enqueue_scripts', 'winwar_enqueue_fonts' );